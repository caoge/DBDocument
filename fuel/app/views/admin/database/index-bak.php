<div class="col-md-3">
	<div class="list-group">
		...
		<a href="<?php echo Uri::create('admin/database/table'); ?>" class="list-group-item"><span class="glyphicon glyphicon-calendar"></span> 文档</a>
		<a href="<?php echo Uri::create('admin/database/field'); ?>" class="list-group-item"><span class="glyphicon glyphicon-tag"></span> 日志</a>
	</div>
</div>
<div class="col-md-9">
	<ol class="breadcrumb">
	  <li><a href="<?php echo Uri::create('admin/database/index'); ?>">服务器</a></li>
	  <li><a href="<?php echo Uri::create('admin/database/db'); ?>">数据库</a></li>
	  <li class="active">表</li>
	</ol>
